...
- Veri Yapısı: Dictionary olarak gelen veri, işlenebilir List<Currency yapısına dönüştürülmüştür.
...
Tüm veriler çalışma anında canlı olarak çekilir (Hard-coded veri içermez).
